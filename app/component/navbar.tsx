...
//   return (
//     <div>
//         <div className='bg-black text-white px-10  py-5 flex flex-row gap-x-16 items-center '>
//         <div className='flex flex-col gap-y-0'>
//   <div className='font-serif font-bold text-2xl space-y-0'>
//     <Link href={""}>
//       <span className='text-orange-400'>MO</span>
//       <span className='text-orange-600'>MS</span>
//       <p className='text-xs font-extralight text-orange-500 mt-0 '>Serving Happiness</p>
//     </Link>
//   </div>
...
//             <Link href={""} className='text-gray-400'>CATALOG</Link>
//             <Link href={""}  className='text-gray-400'>PLACES</Link>
//             <Link href={""}  className='text-gray-400'>BLOG</Link>
//             <Link href={""}  className='text-gray-400'>CONTACT</Link>
//           </div>
//             <div className="flex items-center  justify-around rounded-2xl p-1 w-[400px] bg-gray-500 px-4">
//             <input type="text" placeholder='Search' className="flex-grow  outline-none bg-gray-500  rounded-2xl" />
...
//             <button className=" text-xs py-2 px-8 rounded-2xl bg-gradient-to-r from-orange-400 to-orange-700 hover:from-orange-700 hover:to-orange-400">Creat Accoun</button>
...
//           <div className='flex gap-y-4  flex-col text-sm '>
//             <Link href={""} className='font-semibold'>ABOUT US</Link>
//             <Link href={""} className='text-gray-400'>CATALOG</Link>
//             <Link href={""}  className='text-gray-400'>PLACES</Link>
//             <Link href={""}  className='text-gray-400'>BLOG</Link>
//             <Link href={""}  className='text-gray-400'>CONTACT</Link>
//           </div>
//             <div className="flex items-center  justify-around rounded-2xl p-1 w-[200px] bg-gray-500 px-4">
//             <input type="text" placeholder='Search' className="flex-grow  outline-none bg-gray-500  rounded-2xl" />
//             <CiSearch className="text-white" />
//           {/* <CiSearch className="text-gray-500" />            */}
//             </div>
